package fr.slashandroses.mhcraft.common.screen;
...
public class GlassCutterScreen extends HandledScreen<GlassCutterContainer> {
    ...
    public GlassCutterScreen(GlassCutterContainer handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawMouseoverTooltip(MatrixStack matrices, int x, int y) {
        ...
        if (this.canCraft) {
            ...
            List<GlassCutterRecipe> list = this.handler.getAvailableRecipes();
